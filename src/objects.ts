...
export function toMarkdown(question: Question): string {
    let markdownString = "";
    markdownString += "# " + question.name + "\n";
    markdownString += question.body;
...
export function renameQuestion(question: Question, newName: string): Question {
    const renamedQuestion: Question = { ...question };
...
export function publishQuestion(question: Question): Question {
    const invertPublish: Question = { ...question };

    if (invertPublish.published === false) {
        invertPublish.published = true;
    } else {
        invertPublish.published = false;
    }
...
export function duplicateQuestion(id: number, oldQuestion: Question): Question {
    ...
    // duplicatedQuestion.name = "Copy of " + name;
...
export function addOption(question: Question, newOption: string): Question {
    ...
    updatedQuestion.options = [...question.options, newOption];
